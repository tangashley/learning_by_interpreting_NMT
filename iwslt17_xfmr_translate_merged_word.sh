...
SRC=fr
TRG=en
TEXT=iwslt17.tokenized_xfmr_merged_words.fr-en

#(7) Decoding NMT Model
DATA_BIN=data-bin/iwslt17_xfmr_merged_words_${SRC}_${TRG}
CPKT=checkpoint/iwslt17_xfmr_merged_words_fine_tune_${SRC}_${TRG}
RESULT=result/iwslt17_xfmr_merged_words_fine_tune_${SRC}_${TRG}

mkdir -p $RESULT

CUDA_VISIBLE_DEVICES=$GPU  python fairseq/fairseq_cli/interactive.py $DATA_BIN \
